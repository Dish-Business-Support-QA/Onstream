...
class TestHomeScreen:
    def test_images_displayed(self):
        ...
        try:
            ...
            self.driver.find_element_by_xpath('//img[@alt="Wylde Logo"]').is_displayed()  # custom_logo
...
class TestSideBarScreen:
    def test_images_displayed(self):
        ...
        try:
            ...
            """self.driver.find_element_by_xpath('//img[@src="http://supair.dishanywhere.com/supair'
                                              '/0f/4d/0f4d0fa54c8cc9bdb0ec9a21953d710f.png"]').is_displayed()
            # channel logo"""
        ...
        try:
            if ":" + str(30) in self.now:
                try:
                    ...
                    ActionChains(self.driver).move_to_element_with_offset(service, 0, 0).perform()  # hover mouse over it
            ...
            back = WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '//a[contains(text(), "BACK TO PROGRAM GUIDE")]')))  # Go back to Full Guide
            ActionChains(self.driver).move_to_element(back).perform()  # hover mouse over it
            ActionChains(self.driver).click(back).perform()  # click on the service
            ...
            self.driver.find_element_by_xpath('//img[@id="bmpui-id-79"]').is_displayed()  # Channel logo top right
