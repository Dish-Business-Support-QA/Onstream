...
class TestGuideScreen:
    def test_images_displayed(self):
        ...
        try:
            ...
            self.driver.find_element_by_xpath \
                ('//span[@class="_3BUdesL_Hri_ikvd5WhZhY _3A8PSs77Wrg10ciWiA2H_B  "]').is_displayed()  # underline
            self.driver.find_element_by_xpath(
                '//div[@class="_2JbshVQf7cKfzSj6SAqTiq"]').is_displayed()  # channel logos
            self.driver.find_element_by_xpath(
                '//div[@class="_3mtdocLQZjeofa83PD2_vL"]').is_displayed()  # vertical bar
        except NoSuchElementException as e:
            self.driver.save_screenshot(self.direct + self.name + ".png")
            raise Exception("Element could not be found! Please view the Screenshot!") from e
        except TimeoutException as t:
    ...
    def test_buttons_displayed(self):
        try:
            self.driver.find_element_by_xpath(
                '//div[@class="_33q8pPVDOZ2wsVJzvR3jdy"]').is_displayed()  # right arrow
    ...
    def test_images_displayed(self):
        ...
        try:
            info = WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '(//div[@class="A7qtluKp_shMOW5H57lxU"])[2]')))  # go to the more info button
            time.sleep(10)
            ...
            self.driver.find_element_by_xpath(
                '//div[@class="_2hHA9bFIq-vRi5vrWcTHJY"]').is_displayed()  # show picture
            self.driver.find_element_by_xpath('//div[@class="_1oUh3apnwdwzBiB_Uw6seb "]').is_displayed()  # banner
            self.driver.find_element_by_xpath('//img[@alt="Dish Logo"]').is_displayed()  # dish
            self.driver.find_element_by_xpath('//img[@alt="Dish Logo"]').is_displayed()  # custom_logo
            self.driver.find_element_by_xpath('//div[@class="Wjmljsl8wM6YcCXO7StJi"]').is_displayed()  # line
...
class TestLiveTV:
    def test_images_displayed(self):
        ...
        try:
            ...
            # Right Arrow
            self.driver.find_element_by_xpath(
                '//div[@class="bmpui-ui-container bmpui-moreInfoIcon"]').is_displayed()
            # info emblem
        except NoSuchElementException as e:
            self.driver.save_screenshot(self.direct + self.name + ".png")
            raise Exception("Element could not be found! Please view the Screenshot!") from e
    ...
    def test_text_displayed(self):
        try:
            ...
            # Run Time of Service
            self.driver.find_element_by_xpath(
                '//span[@class="bmpui-ui-playbacktimelabel bmpui-text-right"]').is_displayed()
    ...
    def test_buttons_displayed(self):
        try:
            ...
            self.driver.find_element_by_xpath('//a[@class="_2GEDK4s6kna2Yfl6_0Q6c_"]').is_displayed()  # play button
            self.driver.find_element_by_xpath(
                '//button[@class="bmpui-ui-volumetogglebutton bmpui-muted"]').is_displayed()
            # Mute button
    ...
    def test_buttons_enabled(self):
        try:
            self.driver.find_element_by_xpath(
                '//div[@class="bmpui-ui-container bmpui-fullTvGuideIcon"]').is_enabled()
            # Full TV Guide back button
            self.driver.find_element_by_xpath('//div[@class="bmpui-ui-container bmpui-moreInfoIcon"]').is_enabled()
            # More Info button
            self.driver.find_element_by_xpath(
                '//span[@class="bmpui-ui-label bmpui-miniEpgToggleLabel"]').is_enabled()
            # Mini Guide down button
            ...
            self.driver.find_element_by_xpath('//a[@class="_2GEDK4s6kna2Yfl6_0Q6c_"]').is_enabled()  # play button
            self.driver.find_element_by_xpath(
                '//button[@class="bmpui-ui-volumetogglebutton bmpui-muted"]').is_enabled()
            # Mute button
    ...
    def test_control_bar_functions(self):
        try:
            ...
            self.driver.find_element_by_xpath(
                '//button[@class="bmpui-ui-volumetogglebutton bmpui-unmuted"]').click()
            ...
            self.driver.find_element_by_xpath(
                '//button[@class="bmpui-ui-fullscreentogglebutton bmpui-off"]').click()
            #  turn full screen on
            WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '//button[@class="bmpui-ui-fullscreentogglebutton bmpui-on"]'))).is_displayed()
            # full screen on
            self.driver.find_element_by_xpath('//button[@class="bmpui-ui-fullscreentogglebutton bmpui-on"]').click()
            #  turn full screen off
            WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '//button[@class="bmpui-ui-fullscreentogglebutton bmpui-off"]'))).is_displayed()
            # full screen on
...
class TestLegalSettingsScreen:
    def test_images_displayed(self):
        ...
        try:
            ...
            service = WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH,
                 '//a[@class="_1jBpd9Hw7kDuuvGVNTNlax schema_accent_background_hover"][2]')))
            # go to the legal Button
            ActionChains(self.driver).move_to_element(service).perform()  # hover mouse over it
            ActionChains(self.driver).click(service).perform()  # click on the Support Button
            WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
    ...
    def test_link1_clickable(self):
        try:
            ...
            WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '//h1[contains(text(), "DISH Network Service Agreements")]'))).is_displayed()
        except NoSuchElementException as e:
            self.driver.save_screenshot(self.direct + self.name + ".png")
            raise Exception("Element could not be found! Please view the Screenshot!") from e
        except TimeoutException as t:
    ...
    def test_link2_clickable(self):
        ...
        # go to the legal Button
        ActionChains(self.driver).move_to_element(service).perform()  # hover mouse over it
        ActionChains(self.driver).click(service).perform()  # click on the legal Button
        WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
            (By.XPATH, '//div[@class="_2hNvqt9m_HItaYpgkx528X"]')))
        try:
            self.driver.find_element_by_xpath('//a[@href="https://www.dish.com/terms-conditions/"]').click()
            WebDriverWait(self.driver, 30).until(ec.presence_of_element_located(
                (By.XPATH, '//h1[contains(text(), "Important Terms and Conditions")]'))).is_displayed()
        except NoSuchElementException as e:
            self.driver.save_screenshot(self.direct + self.name + ".png")
            raise Exception("Element could not be found! Please view the Screenshot!") from e
        except TimeoutException as t:
