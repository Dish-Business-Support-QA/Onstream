...
def pytest_addoption(parser):
    ...
    parser.addoption("--smartbox_ip", dest="smartbox_ip", action="store", default="https://10.11.46.143", help="The IP of the SMARTBOX which has the channel lineup for the Onstream instance you are testing with")
    ...
    parser.addoption("--grafana_ip", dest="grafana_ip", action="store", default="localhost", help="The IP of the Grafana instance")
    parser.addoption("--grafana_port", dest="grafana_port", action="store", default="8086", help="The IP of the Grafana instance")
    parser.addoption("--custom_logo", dest="custom_logo", action="store", default="DaVita Logo", help="The Custom Logo which appears in the middle of the main page for OnStream")
